...
using System.Linq;
using FactoryFactory.Tests.MicrosoftTests.Fakes;
using Microsoft.Extensions.DependencyInjection;
using Xunit;
using ClassWithInternalConstructor = FactoryFactory.Tests.MicrosoftTests.Fakes.ClassWithInternalConstructor;
