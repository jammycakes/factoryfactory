...
namespace FactoryFactory
{
        ...
        IServiceProviderFactory<IServiceCollection>
    {
        ...
        IServiceProvider IServiceProviderFactory<Registry>.CreateServiceProvider
            (Registry containerBuilder)
        {
            return containerBuilder.CreateContainer(_options);
        }

        IServiceCollection IServiceProviderFactory<IServiceCollection>.CreateBuilder
            (IServiceCollection services)
        {
            return new Registry(services);
        }

        IServiceProvider IServiceProviderFactory<IServiceCollection>.CreateServiceProvider
